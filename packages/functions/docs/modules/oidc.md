...
[packages/functions/src/oidc/aws-credentials-provider.ts:70](https://github.com/samcx/vercel-extensions/blob/main/packages/functions/src/oidc/aws-credentials-provider.ts#L70)
